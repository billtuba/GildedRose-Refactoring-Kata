...
(t/deftest backstage-passes-increase-with-age-up-to-expiration
  (t/are [it expected]
    ...
    {:name sut/BACKSTAGE_PASS :quality 1 :sell-in 11}
    {:name sut/BACKSTAGE_PASS :quality 2 :sell-in 10}

    {:name sut/BACKSTAGE_PASS :quality 1 :sell-in 10}
    {:name sut/BACKSTAGE_PASS :quality 3 :sell-in 9}

    {:name sut/BACKSTAGE_PASS :quality 1 :sell-in 5}
    {:name sut/BACKSTAGE_PASS :quality 4 :sell-in 4}

    {:name sut/BACKSTAGE_PASS :quality 1 :sell-in 1}
    {:name sut/BACKSTAGE_PASS :quality 4 :sell-in 0}

    {:name sut/BACKSTAGE_PASS :quality 50 :sell-in 0}
...
(t/deftest sulfuras-never-decreases-in-quality
  (t/are [it expected]
    ...
    {:name sut/SULFURAS :quality 10 :sell-in 0}
    {:name sut/SULFURAS :quality 10 :sell-in 0}))
...
(t/deftest quality-is-capped-at-50
  (t/are [it expected]
    ...
    {:name sut/AGED_BRIE :quality 49 :sell-in 2}
    {:name sut/AGED_BRIE :quality 50 :sell-in 1}

    {:name sut/AGED_BRIE :quality 50 :sell-in 2}
    {:name sut/AGED_BRIE :quality 50 :sell-in 1}))

(t/deftest aged-brie-quality-increases-with-age
  (t/are [it expected]
         (m/match? expected (sut/update-item it))
    {:name sut/AGED_BRIE :quality 0 :sell-in 2}
